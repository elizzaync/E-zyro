...
class CuentaBancaria(Base):
    ...
    cuenta_contable_id = Column(String(36), ForeignKey("cuenta_contable.id"), nullable=False)
...
class MovimientoBancario(Base):
    ...
    id                 = Column(String(36), primary_key=True, default=_uuid)
    empresa_id         = Column(String(36), ForeignKey("empresa.id"), nullable=False)
    cuenta_bancaria_id = Column(String(36), ForeignKey("cuenta_bancaria.id"), nullable=False)
    ...
    conciliado_por_id  = Column(String(36), ForeignKey("empleado.id"), nullable=True)
