...
CATALOGO_ESTANDAR: list[tuple[str, str, str, bool]] = [
    ...
    ("FERIADO_TRABAJADO", "Trabajo en Día Feriado",                "ingreso",          False),
...
_CODIGOS_MOTOR_LEGAL = frozenset({
    COD_SUELDO_BASE, "HRS_EXTRA", "DOMINGO_TRABAJADO", "FERIADO_TRABAJADO", "ASIG_FAMILIAR",
...
def calcular_planilla(db: Session, empresa_id: str, periodo_id: str) -> Planilla:
    ...
    for emp in empleados:
        ...
        _agregar("FERIADO_TRABAJADO", desglose.pago_feriado)
